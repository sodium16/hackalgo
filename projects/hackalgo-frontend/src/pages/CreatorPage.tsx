      ...
      <div className="card-body gap-4">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm opacity-70">Hackathon demo: uses mocked calls (fast to swap to ABI later).</p>
          </div>
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                enqueueSnackbar(`Minted ${assetIds.length} NFTs (mock)`, { variant: 'success' })
              } catch (e) {
          ...
          <div className="text-sm opacity-80">
            {algoMint.terms ? (
              <>
                ...
                <b>{algoMint.terms.duration_years}</b> years
              </>
            ) : (
              <>No mint yet</>
            )}
